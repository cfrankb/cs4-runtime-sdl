...
const char HISCORE_FILE[] = "/offline/hiscores-cs4.dat";
const char SAVEGAME_FILE[] = "/offline/savegame-cs4.dat";
#else
const char HISCORE_FILE[] = "hiscores-cs4.dat";
const char SAVEGAME_FILE[] = "savegame-cs4.dat";
#endif
